...
const DraggableHeader = (props) => {
  ...
  if (showPreview) {
    return (
      <>
        <header className="w-full min-h-14 flex items-center justify-between" >
            <span>
              {rest.childNode['header-1-1']}
            </span>
            <span>
              {rest.childNode['header-1-2']}
            </span>
            <span>
              {rest.childNode['header-1-3']}
            </span>
        </header>
      </>
    )
  ...
  return (
    <Draggable {...props} >
      <header className="w-full min-h-14 flex items-center justify-between" >
            ...
            <Dropzone
              {...dropzoneProps}
              initialElements={filterInitialElements('header-1-1')}
              id="header-1-1"
              onDrop={_onDrop}
            ...
            <Dropzone
              {...dropzoneProps}
              initialElements={filterInitialElements('header-1-2')}
              id="header-1-2"
              onDrop={_onDrop}
              placeholder="Drop Here"
            />
