...
const DraggableContainer1R2C = (props) => {
  const {
    dropzoneID,
    parentID,
    showBasicContent,
  ...
  if (showPreview) {
    return (
        <div className="w-full min-h-[10vh] flex gap-2 flex-col lg:flex-row bg-[#1114]">
              ...
              {rest.childNode['canvas-1R2C1']}
              </span>
              <span className='w-full lg:w-[50%]' >
              {rest.childNode['canvas-1R2C2']}
              </span>
        </div>
    )
  }
  ...
  return (
    <Draggable {...props} >
      ...
      <div className="w-full min-h-[10vh] flex flex-col gap-2 lg:flex-row bg-[#1114]">
            ...
            <Dropzone
              {...dropzoneProps}
              initialElements={filterInitialElements('canvas-1R2C1')}
              id="canvas-1R2C1"
              onDrop={_onDrop}
            ...
            <Dropzone
              {...dropzoneProps}
              initialElements={filterInitialElements('canvas-1R2C2')}
              id="canvas-1R2C2"
              onDrop={_onDrop}
              placeholder="Drop Here"
            />
...
DraggableContainer1R2C.propTypes = {
  id: PropTypes.string.isRequired,
  showBasicContent: PropTypes.bool.isRequired
};

export default DraggableContainer1R2C;